...
for i = 1:12
    ...
    majorSignature(i) = 1;
    majorSignature(mod(i + 4,12) + 1) = 1;
    majorSignature(mod(i + 7,12) + 1) = 1;
    ...
    minorSignature(i) = 1;
    minorSignature(mod(i + 3,12) + 1) = 1;
    minorSignature(mod(i + 7,12) + 1) = 1;
    ...
    dimSignature(i) = 1;
    dimSignature(mod(i + 3,12) + 1) = 1;
    dimSignature(mod(i + 6,12) + 1) = 1;
    ...
    augSignature(i) = 1;
    augSignature(mod(i + 4,12) + 1) = 1;
    augSignature(mod(i + 8,12) + 1) = 1;
